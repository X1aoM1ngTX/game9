...
public class VerifyCodeEmail {
    public static final String organization = "Game9";
    public static final String title = "Game9 验证码";
    public static final String content =
            "<div style='background-color: #f8f9fa; padding: 40px; text-align:center; border-radius: 10px; max-width: 500px; margin: 0 auto;'>" +
                    "<img src='E:\\Local\\desktop\\Code\\game9\\src\\main\\static\\assets\\GAME9\\game9-blue.png' style='width: 80px; margin-bottom: 20px;' alt='logo'>" +
