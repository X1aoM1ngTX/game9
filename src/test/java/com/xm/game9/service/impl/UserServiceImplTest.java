...
import com.xm.game9.model.request.user.UserLoginRequest;
...
class UserServiceImplTest {
    ...
    void userLogin_Success() {
        ...
        loginRequest.setEncrypted(false);
        ...
        User result = userService.userLogin(loginRequest, request);
    ...
    @Test
    void userLogin_EmptyRequest_ThrowsException() {
        UserLoginRequest loginRequest = new UserLoginRequest();
        ...
        assertEquals(ErrorCode.PARAMS_ERROR.getErrorCode(), exception.getCode());
        assertEquals("登录信息不完整", exception.getMessage());
    }
    ...
    void userLogin_UserNotFound_ThrowsException() {
        ...
        assertEquals(ErrorCode.USER_ACCOUNT_NOT_EXIST.getErrorCode(), exception.getCode());
    ...
    void userLogin_WrongPassword_ThrowsException() {
        ...
        assertEquals(ErrorCode.USER_PASSWORD_ERROR.getErrorCode(), exception.getCode());
